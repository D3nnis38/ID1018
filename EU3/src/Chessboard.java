...
public class Chessboard {
    ...
    public char toFieldR(char row) {
        return (char) (row - FIRST_ROW);
    }

    public char toFieldR(int row) {
        return (char) (row - FIRST_ROW);
    }

    public byte toFieldC(byte column) {
        return (byte) (column - FIRST_COLUMN);
    }

    public byte toFieldC(int column) {
        return (byte) (column - FIRST_COLUMN);
    }

    public boolean isValidField(char row, int column) {
        return isValidField(row, (byte) column);
    }
    ...
    public abstract class Chesspiece {
        ...
        public void moveTo(char row, int column) throws NoSuchFieldException {
            moveTo(row, (byte) column);
        }
    ...
    public class Bishop extends Chesspiece {
        ...
        //Detta kan listas ut genom att titta på enhetscirkeln och då kan man se att cos "motsvarar" x dvs row
        //Och sin "motsvarar" y dvs column
        public void markReachableFields() {
            for (int a = 0; a < 4; a++) {
