...
public class NPolyline implements Polyline {
    ...
    public double length() {
        ...
        while (n.nextNode != null) {
            length += n.corner.distance(n.nextNode.corner);
            n = n.nextNode;
        }
        return length;
    }
    ...
    public void insertBefore(Point corner, String cornerName) {
        ...
        while (n != null) {
            ...
            if (n.nextNode.corner.getName().equals(cornerName)) {
                Node buff = n.nextNode;
                n.nextNode = new Node(corner);
                n.nextNode.nextNode = buff;
                return;
            } else if (n.corner.getName().equals(cornerName)) {
                Node buff = corners;
                corners = new Node(corner);
                corners.nextNode = buff;
                return;
            }
            n = n.nextNode;
        }
